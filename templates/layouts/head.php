    ...
    <meta name="description" content="TuCurauma.cl">
    <meta name="author" content="Kanoa Studio">
    <!-- Favicon -->
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-144719662-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-144719662-1');
    </script>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <script>
    (adsbygoogle = window.adsbygoogle || []).push({
        google_ad_client: "ca-pub-4470876500682977",
