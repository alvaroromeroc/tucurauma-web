        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="top-contacts">
                  <li>
                    <a href="#">
                      <i class='fab fa-whatsapp'></i><span>+5699 555 4433</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class='fas fa-envelope'></i><span>contacto@tucurauma.cl</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
    ...
    <section id="about">
      <div class="container">
        ...
        <div class="col-lg-5">
            ...
            <span class="Whatsapp"><a href="tel:<?=$site['whatsapp'] ?>"><i class='fab fa-whatsapp'></i></a></span>
            <?php endif ?>
            <?php if(isset($site['facebook'])): ?>
            <span class="Facebook"><a href="<?=$site['facebook'] ?>" target="_blank"><i class='fab fa-facebook'></i></a></span>
            <?php endif ?>
            <?php if($site['instagram']!=""): ?>
            <span class="Instagram"><a href="<?=$site['instagram'] ?>" target="_blank"><i class='fab fa-instagram'></i></a></span>
            <?php endif ?>
            </div>
            <!-- fin redes sociales -->
          </div>
          ...
          <?php foreach ($products as $product) { ?>
            <div class="col-lg-4 col-sm-6 col-12">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                  <img class="logo-card" src="<?=$baseUrl?>assets/images/productos/<?=$product['id']?>/<?=$product['image']?>" alt="Card image cap">
...
<footer id="footer" class="bg-one">
  ...
  <script>
    var map;
    function initMap() {
      var myLatLng = {lat: <?=$site['lat']?>, lng: <?=$site['lng']?>};
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDyGM2gGs7ZVz9G5NrqJ3tPI-GQx8X7OA4&callback=initMap" async defer></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/holder/2.9.4/holder.min.js" integrity="sha384-MpKPJqgKw6H2j/qCkQtzi0Vd0Z+3y6KzXp14HmTpXRQH//zby2a3MEuCpj7KJf2n" crossorigin="anonymous"></script>
  </body>
  </html>
